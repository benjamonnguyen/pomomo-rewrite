...
export const execute = async (interaction) => {
    ...
    try {
        ...
        await endFocus(focusMember.guildId, focusMember.channelId, interaction.user.id);
    }
    catch (e) {
